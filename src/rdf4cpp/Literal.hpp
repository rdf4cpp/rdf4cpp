...
private:
    ...
    [[nodiscard]] Literal numeric_binop_impl(OpSelect op_select, Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    ...
    [[nodiscard]] Literal numeric_unop_impl(OpSelect op_select, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] static Literal make_simple_unchecked(std::string_view lexical_form, bool needs_escape, storage::DynNodeStorage node_storage) noexcept;

    /**
     * Creates a non-inlined typed Literal without doing any safety checks or canonicalization.
     */
    [[nodiscard]] static Literal make_noninlined_typed_unchecked(std::string_view lexical_form, bool needs_escape, IRI const &datatype, storage::DynNodeStorage node_storage) noexcept;

    [[nodiscard]] static Literal make_noninlined_special_unchecked(std::any &&value, storage::identifier::LiteralType fixed_id, storage::DynNodeStorage node_storage) noexcept;
     ...
     */
    [[nodiscard]] static Literal make_inlined_typed_unchecked(storage::identifier::LiteralID inlined_value, storage::identifier::LiteralType fixed_id, storage::DynNodeStorage node_storage) noexcept;

    /**
     * Creates an inlined or non-inlined typed Literal without any safety checks
     */
    [[nodiscard]] static Literal make_typed_unchecked(std::any &&value, datatypes::registry::DatatypeIDView datatype, datatypes::registry::DatatypeRegistry::DatatypeEntry const &entry, storage::DynNodeStorage node_storage) noexcept;

    /**
     * Creates a language-tagged Literal directly without any safety checks
     */
    [[nodiscard]] static Literal make_lang_tagged_unchecked(std::string_view lexical_form, bool needs_escape, std::string_view lang, storage::DynNodeStorage node_storage) noexcept;

    [[nodiscard]] static Literal make_lang_tagged_unchecked_from_node_id(std::string_view lang, storage::DynNodeStorage node_storage, storage::identifier::NodeID node_id) noexcept;
    ...
    [[nodiscard]] static Literal make_string_like_copy_lang_tag(std::string_view str, Literal const &lang_tag_src, storage::DynNodeStorage node_storage) noexcept;
    ...
    [[nodiscard]] storage::DynNodeStorage select_node_storage(storage::DynNodeStorage node_storage) const noexcept {
...
public:
     ...
     */
    [[nodiscard]] static Literal make_simple(std::string_view lexical_form, storage::DynNodeStorage node_storage = storage::default_node_storage);
     ...
     * @param node_storage optional custom node_storage used to store the literal
     */
    [[nodiscard]] static Literal make_simple_normalize(std::string_view lexical_form, storage::DynNodeStorage node_storage = storage::default_node_storage);
    ...
    [[nodiscard]] static Literal make_typed_from_value(typename T::cpp_type const &compatible_value,
                                                       storage::DynNodeStorage node_storage = storage::default_node_storage) noexcept {
     ...
     */
    static Literal make_boolean(TriBool b, storage::DynNodeStorage node_storage = storage::default_node_storage);

    /**
     * creates a new string Literal containing a random UUID (Universally Unique IDentifier)
     * @return UUID Literal
     */
    [[nodiscard]] static Literal make_string_uuid(storage::DynNodeStorage node_storage = storage::default_node_storage);
     ...
     */
    [[nodiscard]] static Literal generate_random_double(storage::DynNodeStorage node_storage = storage::default_node_storage);
    ...
    [[nodiscard]] static Literal generate_random_double(Rng &rng, storage::DynNodeStorage node_storage = storage::default_node_storage) {
    ...
    Literal to_node_storage(storage::DynNodeStorage node_storage) const noexcept;
    [[nodiscard]] Literal try_get_in_node_storage(storage::DynNodeStorage node_storage) const noexcept;

private:
    [[nodiscard]] static storage::identifier::NodeID find_datatype_iri(datatypes::registry::DatatypeIDView id, storage::DynNodeStorage node_storage) noexcept;
...
public:
     ...
     * @return
     */
    [[nodiscard]] static Literal find_simple(std::string_view lexical_form, storage::DynNodeStorage node_storage = storage::default_node_storage) noexcept;
     ...
     * @return
     */
    [[nodiscard]] static Literal find_lang_tagged(std::string_view lexical_form, std::string_view lang_tag, storage::DynNodeStorage node_storage = storage::default_node_storage) noexcept;
     ...
     */
    template<datatypes::LiteralDatatype T>
    [[nodiscard]] Literal as_datatype_eq(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept {
        if (this->null()) {
            return Literal{};
        }
     ...
     */
    [[nodiscard]] Literal as_datatype_eq(IRI const &datatype, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_datatype_eq(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal cast(IRI const &target, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;

    /**
     * Identical to Literal::cast except with compile time specified target type.
     */
    template<datatypes::LiteralDatatype T>
    [[nodiscard]] Literal cast(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept {
     ...
     */
    [[nodiscard]] Literal as_lexical_form(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_simplified_lexical_form(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_language_tag(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_language_tag_eq(std::string_view lang_tag, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - other is not rdf:langString
     */
    [[nodiscard]] Literal as_language_tag_eq(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    ...
    [[nodiscard]] Literal as_eq(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator==(Literal const &other) const noexcept;

    [[nodiscard]] TriBool ne(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_ne(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator!=(Literal const &other) const noexcept;

    [[nodiscard]] TriBool lt(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_lt(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator<(Literal const &other) const noexcept;

    [[nodiscard]] TriBool le(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_le(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator<=(Literal const &other) const noexcept;

    [[nodiscard]] TriBool gt(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_gt(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator>(Literal const &other) const noexcept;

    [[nodiscard]] TriBool ge(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_ge(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    TriBool operator>=(Literal const &other) const noexcept;

    [[nodiscard]] bool eq_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_eq_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    [[nodiscard]] bool ne_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_ne_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    [[nodiscard]] bool lt_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_lt_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    [[nodiscard]] bool le_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_le_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    [[nodiscard]] bool gt_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_gt_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    [[nodiscard]] bool ge_with_extensions(Literal const &other) const noexcept;
    [[nodiscard]] Literal as_ge_with_extensions(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;

    [[nodiscard]] Literal add(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator+(Literal const &other) const noexcept;
    Literal &add_assign(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) noexcept;
    Literal &operator+=(Literal const &other) noexcept;

    [[nodiscard]] Literal sub(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator-(Literal const &other) const noexcept;
    Literal &sub_assign(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) noexcept;
    Literal &operator-=(Literal const &other) noexcept;

    [[nodiscard]] Literal mul(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator*(Literal const &other) const noexcept;
    Literal &mul_assign(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) noexcept;
    Literal &operator*=(Literal const &other) noexcept;

    [[nodiscard]] Literal div(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator/(Literal const &other) const noexcept;
    Literal &div_assign(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) noexcept;
    Literal &operator/=(Literal const &other) noexcept;

    [[nodiscard]] Literal pos(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator+() const noexcept;

    [[nodiscard]] Literal neg(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator-() const noexcept;
     ...
     */
    [[nodiscard]] Literal abs(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal round(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal floor(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal ceil(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_strlen(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_language_tag_matches_range(std::string_view lang_range, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_language_tag_matches_range(Literal const &lang_range, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_regex_matches(regex::Regex const &pattern, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     * @todo implement other flags
     */
    [[nodiscard]] Literal as_regex_matches(Literal const &pattern, Literal const &flags = Literal::make_simple(""), storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal regex_replace(regex::RegexReplacer const &replacer, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    ...
    [[nodiscard]] Literal regex_replace(Literal const &pattern, Literal const &replacement,
                                        ...
                                        storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - this is not string-like
     */
    [[nodiscard]] Literal as_contains(std::string_view needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_contains(Literal const &needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal substr_before(std::string_view needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *          - needle could not be found in this
     */
    [[nodiscard]] Literal substr_before(Literal const &needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *          - needle could not be found in this
     */
    [[nodiscard]] Literal substr_after(std::string_view needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *          - needle could not be found in this
     */
    [[nodiscard]] Literal substr_after(Literal const &needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - this is not string-like
     */
    [[nodiscard]] Literal as_str_starts_with(std::string_view needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_str_starts_with(Literal const &needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - this is not string-like
     */
    [[nodiscard]] Literal as_str_ends_with(std::string_view needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - the language tags of this and needle do not match
     */
    [[nodiscard]] Literal as_str_ends_with(Literal const &needle, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - this is not string-like
     */
    [[nodiscard]] Literal uppercase(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     *      - this is not string-like
     */
    [[nodiscard]] Literal lowercase(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal concat(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] static Literal encode_for_uri(std::string_view string, storage::DynNodeStorage node_storage = storage::default_node_storage);
    /**
     * @see https://www.w3.org/TR/xpath-functions/#func-encode-for-uri
     * @return URL encoded string type literal or the null literal if
     *      - this is not string-like
     */
    [[nodiscard]] Literal encode_for_uri(storage::DynNodeStorage node_storage = keep_node_storage) const;
...
private:
     ...
     */
    [[nodiscard]] Literal hash_with(const char *alg, storage::DynNodeStorage node_storage) const;
...
public:
     ...
     */
    [[nodiscard]] Literal md5(storage::DynNodeStorage node_storage = keep_node_storage) const;
    /**
     ...
     */
    [[nodiscard]] Literal sha1(storage::DynNodeStorage node_storage = keep_node_storage) const;
    /**
     ...
     */
    [[nodiscard]] Literal sha256(storage::DynNodeStorage node_storage = keep_node_storage) const;
    /**
     ...
     */
    [[nodiscard]] Literal sha384(storage::DynNodeStorage node_storage = keep_node_storage) const;
     ...
     */
    [[nodiscard]] Literal sha512(storage::DynNodeStorage node_storage = keep_node_storage) const;
     ...
     */
    [[nodiscard]] static Literal now(storage::DynNodeStorage node_storage = storage::default_node_storage) noexcept;
     ...
     */
    [[nodiscard]] Literal as_year(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     * @return xsd::Integer or null literal
     */
    [[nodiscard]] Literal as_month(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     * @return xsd::Integer or null literal
     */
    [[nodiscard]] Literal as_day(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     * @return xsd::Integer or null literal
     */
    [[nodiscard]] Literal as_hours(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     * @return xsd::Integer or null literal
     */
    [[nodiscard]] Literal as_minutes(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_seconds(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_timezone(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
     ...
     */
    [[nodiscard]] Literal as_tz(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    ...
    [[nodiscard]] Literal logical_and(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator&&(Literal const &other) const noexcept;

    [[nodiscard]] Literal logical_or(Literal const &other, storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator||(Literal const &other) const noexcept;

    [[nodiscard]] Literal logical_not(storage::DynNodeStorage node_storage = keep_node_storage) const noexcept;
    Literal operator!() const noexcept;
