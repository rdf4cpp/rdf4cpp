...
#ifndef RDF4CPP_PLAINIRI_H
#define RDF4CPP_PLAINIRI_H
...
namespace rdf4cpp::utils {
    ...
    public:
        ...
        static sec::Result<PlainIRI, error::InvalidIRIError> create(std::string iri_string);
    ...
    private:
        explicit PlainIRI(std::string iri_string);
        std::string iri;
    };

}
#endif  //RDF4CPP_PLAINIRI_HPP
