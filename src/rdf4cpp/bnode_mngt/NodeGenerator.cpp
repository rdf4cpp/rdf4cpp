...
Node NodeGenerator::generate_node_impl(NodeScope const *scope, storage::DynNodeStoragePtr node_storage) {
    return Node{factory->make_node(*this->generator, scope, node_storage)};
}

Node NodeGenerator::generate_node(storage::DynNodeStoragePtr node_storage) {
