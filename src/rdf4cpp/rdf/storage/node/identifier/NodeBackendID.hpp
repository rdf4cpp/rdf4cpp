...
struct dice::hash::dice_hash_overload<Policy, rdf4cpp::rdf::storage::node::identifier::NodeBackendID> {
    static inline size_t dice_hash(rdf4cpp::rdf::storage::node::identifier::NodeBackendID const &x) noexcept {
        return dice::hash::dice_hash_templates<Policy>::dice_hash(x.to_underlying());
    }
};

template<>
struct std::hash<rdf4cpp::rdf::storage::node::identifier::NodeBackendID> {
    inline size_t operator()(rdf4cpp::rdf::storage::node::identifier::NodeBackendID const &v) const noexcept {
