...
rdf4cpp::rdf::parser::RDFFileParser::Iterator rdf4cpp::rdf::parser::RDFFileParser::begin() {
    ...
    return {std::make_unique<std::ifstream>(std::move(stream)),
            std::make_unique<IStreamQuadIterator>(stream, flags_, IStreamQuadIterator::prefix_storage_type {}, node_storage_)};
}
std::default_sentinel_t rdf4cpp::rdf::parser::RDFFileParser::end() {
    return {};
}

rdf4cpp::rdf::parser::RDFFileParser::Iterator::Iterator(std::unique_ptr<std::ifstream> &&stream, std::unique_ptr<IStreamQuadIterator> &&iter)
...
bool rdf4cpp::rdf::parser::RDFFileParser::Iterator::operator==(const rdf4cpp::rdf::parser::RDFFileParser::Iterator &other) const noexcept {
    if (iter_ == nullptr || other.iter_ == nullptr)
