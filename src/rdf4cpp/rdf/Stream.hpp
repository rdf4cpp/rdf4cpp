...
struct Sink {
    ...
    [[nodiscard]] static Sink make_string_sink() noexcept {
        return Sink{
    ...
    [[nodiscard]] static Sink make_ostream_sink() noexcept {
        return Sink{
    ...
    [[nodiscard]] static Sink make_c_file_sink() noexcept {
        return Sink{
                .write = [](void const *buf, size_t elem_size, size_t len, void *stream) {
...
struct Source {
    ...
    [[nodiscard]] static Source make_string_view_source() noexcept {
        return Source{
    ...
    [[nodiscard]] static Source make_istream_source() noexcept {
        return Source{
                .read = [](void *buf, size_t elem_size, size_t len, void *stream_) {
    ...
    [[nodiscard]] static Source make_c_file_source() noexcept {
        return Source{
