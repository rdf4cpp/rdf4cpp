...
public:
     ...
     * @return
     */
    [[nodiscard]] nonstd::expected<IRI, IRIFactoryError> from_relative(std::string_view rel, storage::node::DynNodeStorage node_storage = storage::node::default_node_storage) const noexcept;
    /**
     ...
     * @return
     */
    [[nodiscard]] nonstd::expected<IRI, IRIFactoryError> from_prefix(std::string_view prefix, std::string_view local, storage::node::DynNodeStorage node_storage = storage::node::default_node_storage) const;
     ...
     * @return
     */
    [[nodiscard]] static nonstd::expected<IRI, IRIFactoryError> create_and_validate(std::string_view iri, storage::node::DynNodeStorage node_storage = storage::node::default_node_storage) noexcept;
};
