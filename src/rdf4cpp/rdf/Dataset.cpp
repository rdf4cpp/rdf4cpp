...
storage::node::identifier::NodeBackendID Dataset::to_node_id(Node node) noexcept {
    return node.backend_handle().id();
}

Node Dataset::to_node(storage::node::identifier::NodeBackendID id) const noexcept {
