...
Node NodeScope::generate_node(NodeGenerator &generator, storage::node::DynNodeStorage node_storage) const {
...
Node NodeScope::get_or_generate_node(std::string_view label, NodeGenerator &generator, storage::node::DynNodeStorage node_storage) {
