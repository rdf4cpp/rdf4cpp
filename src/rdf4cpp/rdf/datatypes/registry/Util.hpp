 ...
 */
template<typename F, typename Tuple> requires AccessibleTuple<std::remove_cvref_t<Tuple>>
 ...
 */
template<typename Acc, typename F, typename Tuple> requires AccessibleTuple<std::remove_cvref_t<Tuple>>
 ...
 * @return the final accumulator value
 */
template<typename Tuple, typename Acc, typename F> requires HasTupleTraits<Tuple>
