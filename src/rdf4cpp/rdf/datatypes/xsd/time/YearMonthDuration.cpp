...
template<>
bool capabilities::Default<xsd_yearMonthDuration>::serialize_canonical_string(cpp_type const &value, writer::BufWriterParts parts) noexcept {
    if (value.count() == 0) {
        return writer::write_str("P0M", parts);
    }
