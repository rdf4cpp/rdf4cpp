...
template<>
bool capabilities::Default<xsd_decimal>::serialize_canonical_string(const cpp_type &value, void *buffer, writer::Cursor *cursor, writer::FlushFunc flush) noexcept;
