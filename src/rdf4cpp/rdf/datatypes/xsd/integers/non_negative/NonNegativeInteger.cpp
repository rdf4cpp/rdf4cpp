...
template<>
std::partial_ordering capabilities::Comparable<xsd_non_negative_integer>::compare(cpp_type const &lhs, cpp_type const &rhs) {
    if (lhs < rhs) {
...
template ConversionTable auto make_conversion_table_for<xsd::NonNegativeInteger>();
