 ...
 */
constexpr static registry::ConstexprString xsd_gMonth{"http://www.w3.org/2001/XMLSchema#gMonth"};
 ...
 */
template<>
inline LiteralDatatypeImpl<xsd_gMonth>::cpp_type LiteralDatatypeImpl<xsd_gMonth>::from_string(std::string_view s) {
 ...
 */
template<>
inline std::string LiteralDatatypeImpl<xsd_gMonth>::to_string(const cpp_type &value) {
...
/**
 * Implementation of xsd::gMonth
 */
using GMonth = registry::LiteralDatatypeImpl<registry::xsd_gMonth>;
}  // namespace rdf4cpp::rdf::datatypes::xsd
