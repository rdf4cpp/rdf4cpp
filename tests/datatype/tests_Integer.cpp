...
TEST_CASE("Datatype Integer") {
    ...
    CHECK_THROWS_WITH_AS(no_discard_dummy = Literal::make_typed("a23dg", type_iri), "xsd:integer parsing error: Unexpected character encountered in input.", InvalidNode);
