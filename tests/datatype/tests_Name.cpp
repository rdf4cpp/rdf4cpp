...
TEST_CASE("Datatype Name") {
    ...
    constexpr auto correct_type_iri_cstr = "http://www.w3.org/2001/XMLSchema#name";

    CHECK(std::string(datatypes::xsd::Name::identifier) == correct_type_iri_cstr);

    auto type_iri = IRI(datatypes::xsd::Name::identifier);
    CHECK(type_iri.identifier() == correct_type_iri_cstr);

    using type = datatypes::xsd::Name::cpp_type;

    CHECK(std::is_same_v<type, std::string>);

    std::string value = "Bob";
    auto lit1 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit1.value<datatypes::xsd::Name>() == value);
    CHECK(lit1.lexical_form() == value);

    value = "Alice";
    auto lit2 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit2.value<datatypes::xsd::Name>() == value);
    CHECK(lit2.lexical_form() == value);

    value = "Bob";
    auto lit3 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit3.value<datatypes::xsd::Name>() == value);
    CHECK(lit3.lexical_form() == value);

    value = "12sdfs2df";
    auto lit4 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit4.value<datatypes::xsd::Name>() == value);
    CHECK(lit4.lexical_form() == value);

    value = "ab:ab-123";
    auto lit5 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit5.value<datatypes::xsd::Name>() == value);
    CHECK(lit5.lexical_form() == value);

    value = "abc xyz";
    auto lit6 = Literal::make<datatypes::xsd::Name>(value);
    CHECK(lit6.value<datatypes::xsd::Name>() == value);
